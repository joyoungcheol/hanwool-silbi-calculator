...
st.set_page_config(
    page_title="한울지점 실손의료비 계산기",
    page_icon="🧾",
    layout="wide",
    initial_sidebar_state="collapsed",
    menu_items={"Get Help": None, "Report a bug": None, "About": "ⓒ 2026 대전한울 지점장 조영철. 본 계산기의 무단 복제·배포·수정 및 영리적 활용을 금지합니다. 무단 배포 및 수정 시 저작권법 등 관련 법령에 따라 책임이 발생할 수 있습니다."}
)
...
.copyright-top {
    ...
    border-left: 8px solid #ffbc00 !important;
...
ⓒ 2026 대전한울 지점장 조영철. All rights reserved.<br>
본 계산기의 무단 복제, 배포, 수정 및 영리적 활용을 금지합니다.<br>
무단 배포 및 수정 시 저작권법 등 관련 법령에 따라 책임이 발생할 수 있습니다.
</div>
""", unsafe_allow_html=True)
...
<strong>만든 사람 : 대전한울 지점장 조영철</strong><br>
본 계산기의 무단 복제, 배포, 수정 및 영리적 활용을 금지합니다.<br>
무단 배포 및 수정 시 저작권법 등 관련 법령에 따라 책임이 발생할 수 있습니다.
</div>
""", unsafe_allow_html=True)
